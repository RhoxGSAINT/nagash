...
cm:add_first_tick_callback(
    function()
        if cm:model():campaign_name_key() == "cr_combi_expanded" then
            ...
            table.insert(rhox_nagash_kalledria.hex_data.rhox_kalledria_jinxed_land.hex, "wh3_dlc24_ritual_ksl_hex_2_kalledria_ie_sartorn")
            table.insert(rhox_nagash_kalledria.hex_data.rhox_kalledria_jinxed_land.hex, "wh3_dlc24_ritual_ksl_hex_2_kalledria_ie_fort_dolganyeir")
            table.insert(rhox_nagash_kalledria.hex_data.rhox_kalledria_jinxed_land.hex, "wh3_dlc24_ritual_ksl_hex_2_kalledria_ie_the_grey")
        end
