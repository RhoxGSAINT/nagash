-------Rhox: This file is shared across all the culture mods I'm in (OvN and Nagash) only thing different is lair_culture_to_effects and lair_action_effects is changed to global from local
