core:add_ui_created_callback(
    function(context)
        if vfs.exists("script/frontend/mod/mixer_frontend.lua")then
            ...
            mixer_add_starting_unit_list_for_faction("mixer_vmp_wailing_conclave", {"rhox_nagash_kalledria_syreen","wh_main_vmp_inf_crypt_ghouls","wh_main_vmp_cav_hexwraiths", "wh_main_vmp_inf_cairn_wraiths"})
